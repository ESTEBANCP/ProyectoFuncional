...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>LUGARES TURISTICOS DE YUCATÁN</h1>
			<address >
				<p>RESGISTRO DE PAGO</p>
				<p>LUGARES,<br>Batusai,<br>YUCATÁN</p>
				<p>(+52) 121 68 35 </p>
			</address>
			<span><img alt="" src="assets/img/dr.png"></span>
		</header>
		<article>
			<h1>	Recipiente</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Constancia. H. Ayutamiento de valladolid</p>
			</div>
		</aside>
	</body>
</html>
