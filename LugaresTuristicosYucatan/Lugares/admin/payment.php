        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i>Reserva de lugares</a>
                    </li>
                    <li>
                        <a class="active-menu" href="payment.php"><i class="fa fa-qrcode"></i>Lugares</a>
                    </li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                          Detalles del lugar<small> </small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
