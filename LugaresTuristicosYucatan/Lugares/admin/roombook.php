        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".sidebar-collapse">
                    <span class="sr-only">Navegación de lugar
</span>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="roombook.php"><i class="fa fa-bar-chart-o"></i> Reserva de Lugares turiticos</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Reserva de lugares<small>	<?php echo  $curdate; ?> </small>
                        </h1>
                    </div>
...
Confirmación de reserva
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                   Detalles de lugares disponibles
